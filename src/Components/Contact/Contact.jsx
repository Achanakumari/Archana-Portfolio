...
const Contact = () => {
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "be01f778-60ae-42a1-a17d-4e9d7bfea527");
        ...
        <div className="contact-left">
          ...
          <div className="contact-details">
            <div className="contact-detail">
              <img src={mail_icon} alt="" /> <p>archanakumari78391@gmail.com</p>
            </div>
            <div className="contact-detail">
              <img src={call_icon} alt="" /> <p>+91-6388509897</p>
            </div>
            <div className="contact-detail">
